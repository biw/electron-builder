 ...
 */
export declare function resolveFromProject(options: ResolveFromProjectOptions): string | null;
/**
 ...
 */
export declare function moduleExistsInProject(projectDir: string, moduleSpecifier: string): boolean;
