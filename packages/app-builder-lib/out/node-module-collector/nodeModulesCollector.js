...
class NodeModulesCollector {
    ...
    async getDependenciesTree(pm) {
        ...
        return (0, builder_util_1.retry)(async () => {
            ...
            shouldRetry: async (error) => {
                ...
                if (((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes("Unexpected end of JSON input")) || ((_b = error.message) === null || _b === void 0 ? void 0 : _b.includes("Unterminated string in JSON"))) {
    ...
    async _getNodeModules(dependencies, result, visited) {
        var _a;
        ...
        for (const d of dependencies.values()) {
            ...
            if (visited.has(d)) {
                builder_util_1.log.debug({ name: d.name }, "skipping already visited dependency (circular reference)");
                continue;
            }
            visited.add(d);
