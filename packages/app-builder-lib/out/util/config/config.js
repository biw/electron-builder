...
async function getConfig(projectDir, configPath, configFromOptions, packageMetadata = new lazy_val_1.Lazy(() => (0, load_1.orNullIfFileNotExist)((0, fs_extra_1.readJson)(path.join(projectDir, "package.json"))))) {
    ...
    if (config.extends == null && config.extends !== null) {
        ...
        if ((dependencies != null && "react-scripts" in dependencies) || (devDependencies != null && "react-scripts" in devDependencies)) {
            ...
            let file = (0, projectModuleResolver_1.resolveFromProject)({
                projectDir,
                moduleSpecifier: "electron-webpack/out/electron-builder.js",
                optional: true,
            });
            if (file === null) {
                file = (0, projectModuleResolver_1.resolveFromProject)({
                    projectDir,
            ...
            if (file !== null) {
                ...
                builder_util_1.log.warn({ package: "electron-webpack" }, "electron-webpack is listed in devDependencies but could not be resolved. " + "Note: electron-webpack is deprecated. Consider migrating to a modern build tool.");
            }
        }
    }
